...
Config.AnimalWait = 10000 -- the amount of time in miliseconds that the animal will wait at the bait until freeroam
Config.KeyShop = 'J'
Config.OpenTime = 01 -- hrs : 24hour clock
Config.CloseTime = 23 -- hrs : 24hour clock
Config.Blip = {
    blipName = 'Jägersmann', -- Config.Blip.blipName
...
-- pelt sell prices
Config.PoorPeltPrice = math.random() * (0.50 - 0.10) + 0.10
Config.GoodPeltPrice = math.random() * (0.50 - 0.10) + 0.10
Config.PerfectPeltPrice = math.random() * (0.50 - 0.10) + 0.10
Config.LegendaryPeltPrice = math.random() * (0.50 - 0.10) + 0.10
-- feathers sell prices
Config.FeathersPrice = math.random() * (0.50 - 0.10) + 0.10
-- Carcass sell prices
Config.PoorCarcassPrice = math.random() * (0.50 - 0.10) + 0.10
Config.GoodCarcassPrice = math.random() * (0.50 - 0.10) + 0.10
Config.PerfectCarcassPrice = math.random() * (0.50 - 0.10) + 0.10
Config.LegendaryCarcassPrice = math.random() * (0.50 - 0.10) + 0.10
...
Config.HuntingZones = {
	{
		...
		animalname  = 'Biber',
		baitname    = 'Pflanzenfresser Köder',
		enterzone   = true,
		health      = 200.0,
		timer       = 60,
	},
	{
		...
		animalname  = 'Puma',
		baitname    = 'Starker Raubtierköder',
		enterzone   = true,
		health      = 200.0,
		timer       = 60,
	},
...
Config.TrapperLocations = {
    -- trapper locations
    {name = 'Stawberry Trapper',      location = 'stawberry-trapper',     coords = vector3(-1753.0448, -394.7346, 156.1362 -0.8),   showblip = false }, -- stawberry
    {name = 'Corngual Trapper',       location = 'corngual-trapper',      coords = vector3(481.7352, 2248.0266, 248.1212 -0.08),    showblip = false }, -- Wapitti
    {name = 'Valentine Trapper',      location = 'valentine-trapper',     coords = vector3(-341.0777, 767.1001, 116.6622 -0.8),     showblip = false }, -- valentine
    {name = 'Manzanita Trapper',      location = 'manzanita-trapper',     coords = vector3(-1981.611, -1650.570, 117.099 -0.8),     showblip = false }, -- Blackwater
    {name = 'Ambario Trapper',        location = 'ambario-trapper',       coords = vector3(-3695.4409, -2622.7432, -13.8394 -0.8),  showblip = false }, -- Armadillo
    {name = 'Tumbleweed Trapper',     location = 'tumbleweed-trapper',    coords = vector3(-5508.1187, -2947.4714, -1.9203 -0.8),   showblip = false }, -- tumbleweed
    {name = 'Grifflies Trapper',      location = 'grifflies-trapper',     coords = vector3(1296.6432, -1279.4338, 75.7966 -0.8),    showblip = false }, -- Rhodes
    {name = 'St Denis Trapper',       location = 'stdenis-trapper',       coords = vector3(2832.5424, -1225.602, 47.661453 -0.8),   showblip = false }, -- stdenis
    {name = 'Roanake Trapper',        location = 'roanake-trapper',       coords = vector3(2539.4578, 809.7834, 75.9239 -0.8),      showblip = false }, -- Elysian pool
...
Config.SpawnAnimal = {
	...
	[2] = { ["Model"] = "mp_a_c_panther_01", 	["Pos"] = vector3(1115.52, 1897.05, 327.23 -1),			["Heading"] = 190.96 },
	[3] = { ["Model"] = "mp_a_c_wolf_01", 		["Pos"] = vector3(-627.36, 528.5, 97.01 -1),			["Heading"] = 299.06 },
	[4] = { ["Model"] = "mp_a_c_beaver_01", 	["Pos"] = vector3(-2357.043, -474.8927, 142.01301 -1),	["Heading"] = 1.227958 },
	[5] = { ["Model"] = "mp_a_c_panther_01", 	["Pos"] = vector3(1456.3269, -7087.985, 75.894462 -1),	["Heading"] = 34.374881 }, -- guarma
	[6] = { ["Model"] = "mp_a_c_cougar_01", 	["Pos"] = vector3(1261.06, 1190.20, 147.40 -1),			["Heading"] = 34.374881 }, -- Ponf Bears
	-- Diamonds 
	[7] = { ["Model"] = "mp_a_c_bear_01", 	    ["Pos"] = vector3(-2723.47, 725.09, 171.32 -1),			["Heading"] = -7.84 }, -- Ponf Bears
	[8] = { ["Model"] = "mp_a_c_bear_01", 	    ["Pos"] = vector3(-2130.42, 124.52, 236.62 -1),			["Heading"] = 137.71 }, -- Ponf Bears

	--[0] = { ["Model"] = "mp_a_c_boar_01", 		["Pos"] = vector3(-1854.97, -1598.9, 107.29 -1),		["Heading"] = 341.83 },
	--[0] = { ["Model"] = "mp_a_c_panther_01", 	    ["Pos"] = vector3(979.01, -1229.21, 60.01 -1),			["Heading"] = 124.6 },
	--[0] = { ["Model"] = "mp_a_c_cougar_01", 	    ["Pos"] = vector3(-2081.77, -175.32, 202.03 -1),		["Heading"] = 173.33 },
	--[0] = { ["Model"] = "mp_a_c_alligator_01", 	["Pos"] = vector3(2341.46, -545.29, 41.92 -1),			["Heading"] = 139.76 },
--Rubys
	[9] = { ["Model"] = "a_c_snake_01", 	["Pos"] = vector3(2317.41455078125, 1137.5675048828125, 96.38571166992188 -1),			["Heading"] = -7.84 }, --snake
	[10] = { ["Model"] = "a_c_snake_01", 	["Pos"] = vector3(2317.41455078125, 1137.5675048828125, 96.38571166992188 -1),			["Heading"] = 137.71 }, -- Snake
	[11] = { ["Model"] = "a_c_snake_01", 	["Pos"] = vector3(2317.41455078125, 1137.5675048828125, 96.38571166992188 -1),			["Heading"] = -7.84 }, --snake
	[12] = { ["Model"] = "a_c_snake_01", 	["Pos"] = vector3(2317.41455078125, 1137.5675048828125, 96.38571166992188 -1),			["Heading"] = 137.71 }, -- Snake
	[13] = { ["Model"] = "a_c_snake_01", 	["Pos"] = vector3(2317.41455078125, 1137.5675048828125, 96.38571166992188 -1),			["Heading"] = -7.84 }, --snake
	[14] = { ["Model"] = "a_c_snake_01", 	["Pos"] = vector3(2317.41455078125, 1137.5675048828125, 96.38571166992188 -1),			["Heading"] = 137.71 }, -- Snake
	[15] = { ["Model"] = "a_c_snake_01", 	["Pos"] = vector3(2317.41455078125, 1137.5675048828125, 96.38571166992188 -1),			["Heading"] = -7.84 }, --snake
	[16] = { ["Model"] = "a_c_snake_01", 	["Pos"] = vector3(2317.41455078125, 1137.5675048828125, 96.38571166992188 -1),			["Heading"] = 137.71 }, -- Snake

	[17] = { ["Model"] = "a_c_snakeblacktailrattle_01", 	["Pos"] = vector3(2304.051025390625, 1135.0902099609375, 96.23624420166016 -1),			["Heading"] = -7.84 }, --snake
	[18] = { ["Model"] = "a_c_snakeblacktailrattle_01", 	["Pos"] = vector3(2304.051025390625, 1135.0902099609375, 96.23624420166016 -1),			["Heading"] = 137.71 }, -- Snake
	[19] = { ["Model"] = "a_c_snakeblacktailrattle_01", 	["Pos"] = vector3(2304.051025390625, 1135.0902099609375, 96.23624420166016 -1),			["Heading"] = -7.84 }, --snake
	[20] = { ["Model"] = "a_c_snakeblacktailrattle_01", 	["Pos"] = vector3(2304.051025390625, 1135.0902099609375, 96.23624420166016 -1),			["Heading"] = 137.71 }, -- Snake
	[21] = { ["Model"] = "a_c_snakeblacktailrattle_01", 	["Pos"] = vector3(2304.051025390625, 1135.0902099609375, 96.23624420166016 -1),			["Heading"] = -7.84 }, --snake
	[22] = { ["Model"] = "a_c_snakeblacktailrattle_01", 	["Pos"] = vector3(2304.051025390625, 1135.0902099609375, 96.23624420166016 -1),			["Heading"] = 137.71 }, -- Snake
	[23] = { ["Model"] = "a_c_snakeblacktailrattle_01", 	["Pos"] = vector3(2304.051025390625, 1135.0902099609375, 96.23624420166016 -1),			["Heading"] = -7.84 }, --snake
	[24] = { ["Model"] = "a_c_snakeblacktailrattle_01", 	["Pos"] = vector3(2304.051025390625, 1135.0902099609375, 96.23624420166016 -1),			["Heading"] = 137.71 }, -- Snake
	
	[25] = { ["Model"] = "mp_a_c_bear_01", 	["Pos"] = vector3(2325.337158203125, 1072.4620361328125, 93.56884765625 -1),			["Heading"] = 137.71 }, -- Ponf Bears

	--[0] = { ["Model"] = "mp_a_c_alligator_01", 	["Pos"] = vector3(2364.126953125, 995.9747314453125, 73.90508270263672 -1),			["Heading"] = 139.76 }, -- Gator["Heading"] = 137.71 }, -- Ponf Bears
}

Config.TrapperShop = {
    -- trapper shop items
    [1] = {    name = "consumable_herbivore_bait",         price = 1,       amount = 50,    info = {},    type = "item",    slot = 1, },
    [2] = {    name = "consumable_predator_bait",          price = 1,       amount = 50,    info = {},    type = "item",    slot = 2, },
    [3] = {    name = "consumable_potent_herbivore_bait",  price = 1.50,    amount = 50,    info = {},    type = "item",    slot = 3, },
    [4] = {    name = "consumable_potent_predator_bait",   price = 1.50,    amount = 50,    info = {},    type = "item",    slot = 4, },
}
